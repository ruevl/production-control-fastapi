...
def upgrade() -> None:
    ...
    op.create_index('idx_work_center_identifier', 'work_centers', ['identifier'], unique=False)
    ...
    op.create_index('idx_batch_work_center', 'batches', ['work_center_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_batch_work_center', table_name='batches')
    ...
    op.drop_index('idx_work_center_identifier', table_name='work_centers')
